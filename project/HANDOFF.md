# Original Claude Design handoff note

Preserved for provenance. This was the README shipped with the Claude Design
export before the project was turned into a Next.js app; the repo README now
describes the application instead.
...
**Read `eyal-doron-course-landing-page/project/Super Talent Landing.dc.html` in
full.** The user had this file open when they triggered the handoff, so it's
almost certainly the primary design they want built. Read it top to bottom —
don't skim. Then **follow its imports**: open every file it pulls in (shared
...
- `eyal-doron-course-landing-page/README.md` — this file
- `eyal-doron-course-landing-page/project/` — the `Eyal Doron course landing page`
